...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,50:161b22,100:0A66C2&height=230&section=header&text=Md.%20Hossney%20Mobarak%20Alvi&fontSize=38&fontColor=ffffff&animation=fadeIn&fontAlignY=28&desc=Architect%20of%20AI%20Systems%20That%20Think%2C%20Act%20%26%20Scale&descSize=17&descAlignY=51&descColor=58a6ff" width="100%"/>
...
> **Founder & CEO @ [Aethon Automation Solutions](https://aethonautomation.com)** | Dhaka, Bangladesh
>
> I build AI systems that replace entire departments. 500+ intelligent workflows shipped. 15+ years turning complex business problems into automated, self-improving pipelines across e-commerce, healthcare, real estate, and education.
...
- Autonomous AI agent systems that handle end-to-end business operations
- Voice AI pipelines with real-time decision making (Vapi, Synthflow, Retell)
- MCP protocol servers for intelligent codebase navigation
- Enterprise automation at scale with n8n, LangChain, and custom orchestrators
...
**[TradieMate](https://github.com/mhmalvi/elevate-mobile-experience)**<br>
Mobile-first business management for trade professionals. Voice workflows, invoicing, Stripe, MYOB/QuickBooks/Xero sync, offline-first.
<br><sub>`React` `Capacitor` `Supabase` `Stripe` `TypeScript`</sub>

</td>
<td width="50%">

**[Neuro Weave](https://github.com/mhmalvi/neuro-weave-knowledge-graph)**<br>
MCP protocol server for AI-driven codebase analysis. Knowledge graphs, neural visualization, intelligent code navigation.
<br><sub>`TypeScript` `MCP` `Knowledge Graphs` `AI`</sub>
...
**[LeadShark](https://github.com/mhmalvi/LeadShark)**<br>
AI-powered lead intelligence pipeline. Automated prospecting, enrichment, scoring, and CRM integration at scale.
<br><sub>`TypeScript` `React` `Supabase` `AI`</sub>

</td>
<td width="50%">

**[Shopify Return Automation](https://github.com/mhmalvi/shopify-return-automation-v3)**<br>
AI return & exchange system for Shopify. GPT-powered suggestions, multi-tenant, real-time analytics.
<br><sub>`Next.js` `OpenAI` `Shopify API` `Supabase`</sub>
...
**[Automation Framework](https://github.com/mhmalvi/automation-framework)**<br>
Python automation framework with human-like browser interactions. Enterprise-grade, scalable workflow engine.
<br><sub>`Python` `Selenium` `Automation`</sub>

</td>
<td width="50%">

**[Coursely LMS](https://github.com/mhmalvi/coursely-lms)**<br>
Full LMS with Agora/Zoom live video, 30+ payment gateways, quiz engine, certificates, REST API.
<br><sub>`Laravel` `Vue.js` `MySQL` `Docker`</sub>
...
<details>
<summary><b>All 97 Repositories by Domain</b></summary>

<br>

| Domain | Highlights | Repos |
|--------|-----------|-------|
| **AI Agents** | [Nexus-AIOS](https://github.com/mhmalvi/Nexus-AIOS), [elma](https://github.com/mhmalvi/elma), [deepseek-chatbot](https://github.com/mhmalvi/deepseek-chatbot), [ecom-chat-engine](https://github.com/mhmalvi/ecom-chat-engine), [catalyst-ai](https://github.com/mhmalvi/catalyst-ai), [autoapply](https://github.com/mhmalvi/autoapply) | 6 |
| **Nexus CRM** | [15-service microservices](https://github.com/mhmalvi/nexus-crm-client) -- leads, users, payments, notifications, chat, email, files, B2B | 15 |
| **E-Commerce** | [ras8](https://github.com/mhmalvi/ras8), [ai-image-studio](https://github.com/mhmalvi/ai-image-studio), [QueCommerz](https://github.com/mhmalvi/QueCommerz), [tradehaus](https://github.com/mhmalvi/tradehaus), [Zaker-Dairy](https://github.com/mhmalvi/Zaker-Dairy) | 5 |
| **Email Marketing** | [quemail-client](https://github.com/mhmalvi/quemail-client), [quemail-server](https://github.com/mhmalvi/quemail-server), [quemail-templates](https://github.com/mhmalvi/quemail-templates), [Email-Marketing-Nodejs](https://github.com/mhmalvi/Email-Marketing-Nodejs) | 4 |
| **Education / LMS** | 7 platforms for ITEC, UCT, NTA, ATR, Alpha College -- Bangladesh, South Africa, Australia | 11 |
| **Quadque Platform** | [web](https://github.com/mhmalvi/quadque-web), [mobile](https://github.com/mhmalvi/quadque-app), [admin](https://github.com/mhmalvi/quadque-admin), [server](https://github.com/mhmalvi/quadque-server), [dashboard](https://github.com/mhmalvi/quadque-dashboard) | 10 |
| **Crowdfunding** | [fundflow-server](https://github.com/mhmalvi/fundflow-server), [fundflow-client](https://github.com/mhmalvi/fundflow-client) | 2 |
| **Other** | Influencer platform, travel, news, billing, landing pages, boilerplates | 44 |
...
**MBA** -- Marketing & HRM | Ahsanullah University of Science & Technology | 2019-2021<br>
**BBA** -- International Business | North South University | 2012-2016

<br>

![HubSpot](https://img.shields.io/badge/HubSpot-Inbound_Marketing-FF7A59?style=flat-square&logo=hubspot&logoColor=white)
![Google](https://img.shields.io/badge/Google-Digital_Marketing-4285F4?style=flat-square&logo=google&logoColor=white)
![T3](https://img.shields.io/badge/T3-Data_Driven_Marketing-000?style=flat-square)
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=mhmalvi&show_icons=true&theme=tokyonight&hide_border=true&count_private=true&include_all_commits=true&ring_color=58a6ff" height="170" alt="Stats" />
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=mhmalvi&layout=compact&theme=tokyonight&hide_border=true&langs_count=10" height="170" alt="Languages" />
</p>

<p align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=mhmalvi&theme=tokyonight&hide_border=true" alt="Streak" />
</p>

<p align="center">
  <img src="https://github-readme-activity-graph.vercel.app/graph?username=mhmalvi&theme=tokyo-night&hide_border=true&area=true&custom_title=Contribution%20Activity" alt="Activity" width="100%" />
</p>
...
<img src="https://komarev.com/ghpvc/?username=mhmalvi&style=flat-square&color=0A66C2&label=Profile+Views" alt="Views" />
...
### Open to collaboration on AI, automation, and systems that scale.
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,50:161b22,100:0A66C2&height=120&section=footer" width="100%"/>
